...
public class ServerFacade {
    ...
    public ClearResult clearApplication() throws Error500Internal, IOException, URISyntaxException {
    ...
    public CreateResult createGame( CreateRequest createRequest) throws Error500Internal, IOException, URISyntaxException {
    ...
    public JoinResult joinGame( JoinRequest joinRequest ) throws Error500Internal, IOException, URISyntaxException {
    ...
    public ListResult listGames( ListRequest listRequest ) throws Error500Internal, IOException, URISyntaxException {
    ...
    public LoginResult login( LoginRequest loginRequest ) throws Error500Internal, IOException, URISyntaxException {
    ...
    public LogoutResult logout( LogoutRequest logoutRequest ) throws Error500Internal, IOException, URISyntaxException {
    ...
    public RegisterResult register( RegisterRequest registerRequest ) throws Error500Internal, IOException, URISyntaxException {
