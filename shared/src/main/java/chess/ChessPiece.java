...
public class ChessPiece {
    ...
    public ChessPiece( ChessGame.TeamColor pieceColor, ChessPiece.PieceType type ) {
        ...
        this.pieceType = type;
        // Optional debug
        if ( Constants.DEBUG_GLOBAL || Constants.DEBUG_CHESS_PIECE )
    ...
    public Collection<ChessMove> pieceMoves( ChessBoard board, ChessPosition myPosition ) {
        ...
        // Optional debug
        if ( Constants.DEBUG_GLOBAL || Constants.DEBUG_CHESS_PIECE )
            System.out.println( "(ChessPiece) Evaluated moves for " + board.getPiece( myPosition ).toString() + "-> " + validMoves.toString() );
        return validMoves;
    }
