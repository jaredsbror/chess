...
public class PawnMovesCalculator implements PieceMovesCalculator {
    ...
    public Collection<ChessMove> pieceMoves( ChessBoard board, ChessPosition position ) {
        ...
        // Optional debug
        if ( Constants.DEBUG_GLOBAL || Constants.DEBUG_PAWN_MOVES_CALCULATOR )
            System.out.println( "(PawnCalculator) Found moves from (" + position.getRow() + "," + position.getColumn() + ") for " + board.getPiece( position ).toString() + ":-> " + validMoves.toString() );
        return validMoves;
    }
    ...
    public void processValidMoves( ChessBoard board, ChessPosition position, ChessGame.TeamColor color ) {
        // Optional debug
        if ( Constants.DEBUG_GLOBAL || Constants.DEBUG_PAWN_MOVES_CALCULATOR )
            System.out.println( "Process valid moves" );
