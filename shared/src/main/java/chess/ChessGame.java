...
public class ChessGame {
    ...
    public Collection<ChessMove> validMoves( ChessPosition startPosition ) {
        ...
        if ( Constants.DEBUG_GLOBAL || Constants.DEBUG_CHESS_GAME )
            System.out.println( "(ChessGame) Valid moves for " + chessPiece + "-> " + actualValidMoves );
    ...
    public void makeMove( ChessMove move ) throws InvalidMoveException {
        ...
        if ( validMoves == null )
            throw new InvalidMoveException( "ERROR: Invalid Starting Position in makeMove() OR not the Piece's Proper Turn" );
        ...
        if ( startColor != gameTeamColor )
            throw new InvalidMoveException( "ERROR: Not this piece's turn " + startPiece );
    ...
    public void setBoard( ChessBoard board ) {
        // Optional debug
        if ( Constants.DEBUG_GLOBAL || Constants.DEBUG_CHESS_GAME )
            System.out.println( "Setting chessBoard to " + board.toString() );
        // Iterate over the chessboard rows...
        for ( int row = Constants.BOARD_MIN_ONE_INDEX; row <= Constants.BOARD_MAX_ONE_INDEX; row++ ) {
            // Iterate over the chessboard columns...
            for ( int col = Constants.BOARD_MIN_ONE_INDEX; col <= Constants.BOARD_MAX_ONE_INDEX; col++ ) {
