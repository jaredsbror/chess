...
//        DatabaseManager.pingTables();
    ...
    public AuthData getAuthDataGivenAuthToken(String authToken) throws DataAccessException {
        ...
        if (resultList.size() != 2) throw new DataAccessException( "Error: Did not receive resultList of size 2 in SQLAuthDAO.getAuthDataGivenAuthToken() -> Size = " + resultList.size());
        // Parse resultList
    ...
    public String createAuthToken(String username) throws DataAccessException {
        ...
        statement = "DELETE FROM authTable WHERE username = ?";
